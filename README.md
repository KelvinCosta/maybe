...
[!IMPORTANT]
> This repository is a fork based on Maybe Finance but is **not affiliated with or endorsed by** Maybe Finance Inc.
> The original repository is no longer actively maintained. You can read more about this in their [final release](https://github.com/maybe-finance/maybe/releases/tag/v0.6.0).

## Hosting

This is a fully working personal finance app that can be [self hosted with Docker](docs/hosting/docker.md).
...
**If you are trying to _self-host_ the app, stop here. You
